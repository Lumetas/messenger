...
<div class='chatId'>
          <span style='position:absolute; top:5px; left: 10px; color:white;' onclick='showDialog(0);'>ᐊ</span>
          ...
          <span style='position:absolute; top:5px; right:20px; color:white;'><?php echo $_COOKIE['id']; ?></span>
              ...
              <input onfocus='' type='text' id='messIn' onkeyup='plsEnter(event)' class='messIn'>
